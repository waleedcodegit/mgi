...
class Create extends Component {
    ...
    create(e){
        Axios.post('/api/create_post',this.state).then(res=>{
        ...
        return (
            <div className="container">
                <div className="top_section_title_div">
                    <h2 className="section_title">Create News/Articals</h2>
                </div>
                <div className="card container content_card_div mt-4 mb-5 pb-5 pt-3">
                   ...
                   <div className="row col-md-12">
                        ...
                        <div class="form-group input_div col-md-4">
                            ...
                            <select onChange={this.type.bind(this)}  type="email" class="form-control " aria-describedby="emailHelp" >
                   ...
                   <div className="row col-md-12">
                        ...
                        <div class="form-group input_div col-md-4">
                            ...
                            <select onChange={this.status.bind(this)} type="select" class="form-control mt-2" >
                   ...
                   <input type="checkbox" onChange={this.feature.bind(this)} checked={this.state.feature} value="feature"></input> Feature on home page? <br></br><br></br>
                    ...
                    <button onClick={this.create.bind(this)} className="btn btn-success">Create</button>
                   </div>
                   {
