...
class EditProduct extends Component {
    ...
    componentDidMount(){
        ...
        Axios.post('/api/get_product_by_id',data).then(res=>{
            ...
            this.setState({
                ...
                short_p_description:dat.short_description,
                out_of_stock:dat.out_of_stock
            })
        })
    }
    ...
    update_varient(id,name,price){
        ...
        Axios.post('/api/update_varients',senderdata).then(res=>{
            Swal.fire({
                icon: 'success',
     ...
     DeleteVarient(id,i){
        ...
        Axios.post('/api/delete_variations',senderdata).then(res=>{
    ...
    update_product(){
        ...
        Axios.post('/api/update_product',senderdata).then(res=>{
                    ...
                    <div className="card content_card_div mt-4 mb-5">
                        ...
                        <div className="row col-md-12">
                            <div class="form-group input_div   col-md-6">
                                ...
                                <textarea value={this.state.short_p_description || ""} onChange={this.short_p_description.bind(this)}  type="email" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp"  />
                            </div>
                        ...
                        <button onClick={this.update_product.bind(this)} style={{width:'70px'}} className="btn btn-success ml-3 mb-5">
                                {
                                    this.state.loading ?
